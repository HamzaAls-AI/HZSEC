        ...
        <div className="grid grid-cols-2 gap-10 min-[900px]:grid-cols-5 min-[900px]:gap-8">
          ...
          <div className="col-span-2 min-[900px]:col-span-2">
            ...
            <div className="flex gap-3 mt-6">
              {/* TODO: replace # with real GitHub org URL */}
              <a href="#" aria-label="GitHub" className="text-muted hover:text-accent transition-colors">
              ...
              {/* TODO: replace # with real X/Twitter handle URL */}
              <a href="#" aria-label="X (Twitter)" className="text-muted hover:text-accent transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
